...
import pushnoteScreenshot from '../images/pushnote.webp';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start" style={{ marginBottom: '2.5rem' }}>
          {/* Left: Text content */}
          <motion.div
          ...
          >
            <img
              src={pushnoteScreenshot}
              alt="PushNote Broadcast Management Interface"
              loading="lazy"
              decoding="async"
              style={{
                width: '100%',
