...
function Meliorus() {
  ...
  return (
    <div className="bg-[#FAF8F5] min-h-screen">
      ...
      {/* HERO */}
      <section id="hero" className="max-w-6xl mx-auto px-6 py-24">
        <h1 className="text-4xl md:text-6xl font-light text-[#2C2416] mb-6">
          I build software for people, not systems.
        </h1>

        <p className="text-lg md:text-xl text-[#5A5248] mb-8">
        ...
        <div className="flex gap-4">
          <button
            ...
            className="px-5 py-2 border border-[#2C2416]"
          >
            View Projects
          </button>
          ...
          <a
            ...
            className="px-5 py-2 border border-[#E8E3DD]"
          >
            View CV
          </a>
        </div>
