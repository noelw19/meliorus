        ...
        {!viewInfo ? (
          <div className='h-screen bg-[#FAF8F5] overflow-hidden'>
            <div className='flex flex-col lg:flex-row h-full'>
              ...
              <div className='w-full lg:w-[35%] xl:w-[30%] h-auto lg:h-screen bg-[#FFFBF8] border-b lg:border-b-0 lg:border-r border-[#E8E3DD] p-8 md:p-10 lg:p-12 flex flex-col overflow-visible'>
                {/* Profile Section */}
                <div className="flex flex-col items-center lg:items-start mt-4 lg:mb-10 flex-shrink-0">
                ...
                {/* Bio Section */}
                <div className='lg:mb-10 lg:pb-10 lg:border-b border-[#E8E3DD] flex-shrink-0'>
                ...
                <div className='pt-8 lg:mt-auto lg:pt-8 lg:border-t border-[#E8E3DD] flex-shrink-0'>
              ...
              <div className='w-full lg:w-[65%] xl:w-[70%] h-auto lg:h-screen overflow-y-auto p-8 md:p-10 lg:p-12'>
                {showAll()}
              </div>
            </div>
          </div>
